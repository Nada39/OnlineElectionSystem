...
public class LoginPage1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlineelectionsystem/image1.jpg"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
           u = new User(SSNTxt.getText());
        if(SSNTxt.getText().equals("Admin"))
        {
            new inputPassword();
            dispose();
        }
...
class inputPassword extends javax.swing.JFrame{

    JLabel l ;
    private JTextField password;
    JButton confirm ;
    
    public inputPassword() throws HeadlessException {
         setSize(250 , 150);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new FlowLayout());
        l = new JLabel();
        l.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        l.setForeground(new java.awt.Color(0, 102, 204));
        l.setText("Please set Password to confirm");
         password = new JTextField(15);
         confirm = new JButton("Confirm");
        confirm.setBackground(new java.awt.Color(0, 102, 204));
        confirm.setFont(new java.awt.Font("Segoe UI", 1, 14));
